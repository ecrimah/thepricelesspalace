...
export default function CartPage() {
  ...
  const { cart: cartItems, removeFromCart, updateQuantity, subtotal, addToCart, appliedCoupon, applyCoupon, removeCoupon, discount: couponDiscount } = useCart();
  ...
  return (
    <div className="min-h-screen bg-white">
      <PageHero title="Shopping Cart" image="/hero-shop.webp" />
