...
export default function ContactPage() {
  ...
  const contactEmail = getSetting("contact_email") || "hello@wholesalequeen.com";
  ...
  const faqs = [
    {
      ...
      answer: "We deliver across Ghana. Delivery timelines depend on your location and are confirmed at checkout. Pickup is available at our Ashongman Estate shop in Accra.",
    },
    {
      question: 'Do you sell wholesale and in bulk?',
      answer: "Yes! Wholesale Queen specialises in China wholesale — Shein bales, mannequins and home appliances at bulk-friendly prices, perfect for resellers and shop owners.",
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-5 gap-10">
            ...
            <div className="lg:col-span-3">
              <div className="bg-white border border-brand-carton/15 rounded-2xl p-6 sm:p-8">
                ...
                <form id="contactForm" onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-brand-carton/30 focus:border-brand-carton text-sm transition-colors bg-gray-50 focus:bg-white"
                        placeholder="Order inquiry, wholesale order, etc."
                      />
                    </div>
                  </div>
                  ...
                  {submitStatus === 'error' && (
                    <div className="bg-[#E89DB5]/30 border border-[#FF6666]/20 text-[#9A1900] px-4 py-3 rounded-xl flex items-center gap-2 text-sm">
                  ...
                  <button
                    ...
                    className="w-full bg-[#141414] text-white py-3.5 rounded-xl font-semibold text-sm hover:bg-brand-carton transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                  >
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {/* WhatsApp CTA */}
              <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#C9A24E] via-[#8A7750] to-[#141414] p-6 text-white">
                ...
                <div className="relative">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 bg-white text-[#141414] px-5 py-2.5 rounded-full text-sm font-semibold hover:bg-[#F3F3F3] transition-colors"
                  >
              ...
              <div className="border border-brand-carton/15 rounded-2xl p-5 bg-brand-cream/30">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 text-sm">Visit Our Shop</h3>
                    <p className="text-sm text-gray-600 mt-1 leading-relaxed">
                      Stop by our Ashongman Estate shop in Accra to shop wholesale in person.
                    </p>
