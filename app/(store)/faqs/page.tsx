...
export default function FAQsPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "You can request changes within 1 hour of placing your order. Contact support immediately at 054 284 9341 or hello@wholesalequeen.com. Once processing starts, changes may be limited."
    },
    {
      category: 'orders',
    ...
    },
    {
      ...
      answer: 'Delivery times depend on your location. We ship from Ashongman Estate, Accra to anywhere in Ghana. Final delivery timelines are shown at checkout and in your order updates.'
    },
    {
      category: 'shipping',
    ...
    {
      category: 'shipping',
      question: 'Do you offer wholesale and bulk orders?',
      answer: 'Yes. Wholesale Queen specialises in China wholesale — Shein bales, mannequins and appliances at bulk-friendly prices, ideal for resellers and shop owners.'
    },
    {
      category: 'shipping',
    ...
    },
    {
      ...
      answer: 'We accept bank transfers, Visa/Mastercard credit and debit cards, and Cash on Delivery for eligible orders within Accra. All payments are processed securely.'
    },
    {
      category: 'payment',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <Link href="/returns" className="bg-gray-50 p-8 rounded-2xl hover:shadow-lg transition-all cursor-pointer">
            ...
            <p className="text-gray-600 leading-relaxed">
              Learn about delivery options across Ghana and pickup.
            </p>
          </Link>
