                ...
                {wasHelpful ? (
                  ...
                  <>
                    <div className="w-16 h-16 flex items-center justify-center bg-[#C9A24E]/10 rounded-full mx-auto mb-4">
                      <i className="ri-customer-service-line text-3xl text-[#C9A24E]"></i>
                    </div>
                    <p className="text-lg font-semibold text-gray-900 mb-2">
                    ...
                    <Link
                      href="/support/ticket"
                      className="inline-block bg-[#141414] hover:bg-[#141414]/90 text-white px-6 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap"
                    >
                      Contact Support
                    </Link>
                  </>
