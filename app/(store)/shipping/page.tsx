...
export default function ShippingPage() {
  const deliveryOptions = [
    ...
    },
    {
      ...
      time: 'Next Day',
      cost: 'GHS 40',
      description: 'Available for Accra & Abuja orders placed before 2pm',
      icon: 'ri-rocket-line'
    },
    {
      type: 'Store Pickup',
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-16">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="w-12 h-12 bg-[#C9A24E]/10 rounded-full flex items-center justify-center mx-auto mb-3">
                <i className="ri-checkbox-circle-line text-2xl text-[#C9A24E]"></i>
              </div>
            ...
            <div className="text-center">
              <div className="w-12 h-12 bg-[#C9A24E]/10 rounded-full flex items-center justify-center mx-auto mb-3">
                <i className="ri-truck-line text-2xl text-[#C9A24E]"></i>
              </div>
