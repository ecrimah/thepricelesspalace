      ...
      <div className="print-section hidden print:block bg-white p-8">
        <div className="border-2 border-gray-800 p-6">
          ...
          <div className="flex justify-between items-start border-b-2 border-gray-800 pb-4 mb-4">
            <div>
              <h1 className="text-2xl font-bold">Wholesale Queen</h1>
...
<p>Thank you for shopping with Wholesale Queen!</p>
              <p>Questions? Contact us at hello@wholesalequeen.com</p>
          </div>
        </div>
      </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-sm text-gray-900 font-mono truncate max-w-[150px]">
                    {order.metadata?.hubtel_client_reference || order.metadata?.moolre_reference || order.metadata?.paystack_reference || order.payment_transaction_id || 'N/A'}
                  </span>
                </div>
              </div>
              {order.payment_status !== 'paid' && (
