      ...
      parameters: {
        ...
        properties: {
          ...
          payment_method: {
            type: 'string',
            enum: ['paystack', 'cod'],
            description: 'Payment method. paystack = online payment (Mobile Money, card, bank transfer), cod = Cash on Delivery (Accra only)',
          },
        },
...
- Always quote prices in ₵ (GHS, Ghana Cedi).
